...
const GrokLogo = ({ s = 14 }) => (
  /* broken ring with a curved blade slashing through — waist at center, swells at the ring, needle tips */
  <svg viewBox="0 0 24 24" width={s} height={s} aria-hidden="true">
    <g stroke={PAPER} strokeWidth="2.8" fill="none" strokeLinecap="butt">
      <path d="M15.24 5.35 A7.4 7.4 0 0 0 5.35 15.24" />
      <path d="M8.76 18.65 A7.4 7.4 0 0 0 18.65 8.76" />
    </g>
    <path fill={PAPER} d="M20.56 2.45 L20.26 2.92 L19.97 3.38 L19.67 3.83 L19.38 4.29 L19.09 4.76 L18.82 5.24 L18.55 5.73 L18.31 6.24 L18.07 6.75 L17.82 7.26 L17.56 7.76 L17.27 8.22 L16.93 8.64 L16.56 9.01 L16.14 9.36 L15.71 9.68 L15.27 9.99 L14.84 10.32 L14.43 10.65 L14.02 11.01 L13.63 11.37 L13.26 11.75 L12.88 12.13 L12.51 12.51 L12.13 12.88 L11.75 13.26 L11.37 13.64 L11.01 14.03 L10.66 14.43 L10.33 14.86 L10.02 15.30 L9.72 15.75 L9.41 16.20 L9.08 16.63 L8.73 17.03 L8.34 17.39 L7.91 17.72 L7.46 18.02 L6.99 18.31 L6.53 18.60 L6.08 18.91 L5.66 19.23 L5.25 19.58 L4.87 19.95 L4.50 20.34 L4.14 20.73 L3.79 21.14 L3.44 21.55 L3.74 21.08 L4.03 20.62 L4.33 20.17 L4.62 19.71 L4.91 19.24 L5.18 18.76 L5.45 18.27 L5.69 17.76 L5.93 17.25 L6.18 16.74 L6.44 16.24 L6.73 15.78 L7.07 15.36 L7.44 14.99 L7.86 14.64 L8.29 14.32 L8.73 14.01 L9.16 13.68 L9.57 13.35 L9.98 12.99 L10.37 12.63 L10.74 12.25 L11.12 11.87 L11.49 11.49 L11.87 11.12 L12.25 10.74 L12.63 10.36 L12.99 9.97 L13.34 9.57 L13.67 9.14 L13.98 8.70 L14.28 8.25 L14.59 7.80 L14.92 7.37 L15.27 6.97 L15.66 6.61 L16.09 6.28 L16.54 5.98 L17.01 5.69 L17.47 5.40 L17.92 5.09 L18.34 4.77 L18.75 4.42 L19.13 4.05 L19.50 3.66 L19.86 3.27 L20.21 2.86 L20.56 2.45 Z" />
  </svg>
);
