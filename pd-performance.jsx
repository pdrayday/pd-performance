...
const GrokLogo = ({ s = 14 }) => (
  /* ring fused with two blade tails, straight cut through, thin center sliver — matches official mark */
  <svg viewBox="0 0 24 24" width={s} height={s} aria-hidden="true">
    <g fill={PAPER}>
      <path d="M21.09 2.13 L15.05 8.17 A4.9 4.9 0 0 0 8.17 15.05 L6.25 16.97 A7.6 7.6 0 1 1 18.58 8.20 C19.38 9.59 19.25 3.97 21.09 2.13 Z" />
      <path d="M2.91 21.87 L8.95 15.83 A4.9 4.9 0 0 0 15.83 8.95 L17.75 7.03 A7.6 7.6 0 1 1 5.42 15.80 C4.62 14.41 4.75 20.03 2.91 21.87 Z" />
      <path d="M15.89 8.11 Q12.60 12.60 8.11 15.89 Q11.40 11.40 15.89 8.11 Z" />
    </g>
  </svg>
);
